...
struct PlayableItemsMenuView_Previews: PreviewProvider {
    static var previews: some View {
        List {
            Section("Single Item") {
                PlayableItemsMenuView(itemsCount: 1) { [] }
            }

            Section("Multiple Items") {
                PlayableItemsMenuView(itemsCount: 24) { [] }
            }
        }
        .previewDisplayName("Playable Menu Actions")
    }
}
